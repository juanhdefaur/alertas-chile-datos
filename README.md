...
- `data/incidentes-chillan.json` — incidentes de Bomberos Chillán (despacho automatizado VIPER vía @despachoscbch), actualizado cada 10 minutos por un GitHub Action.
